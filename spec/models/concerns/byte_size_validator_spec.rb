...
RSpec.describe ContentTypeValidator, type: :concern do
  ...
  class Person < ApplicationRecord
    ...
    validates :avatar, byte_size: { maximum: 600.kilobytes }
  end
  ...
  context 'given a valid attachment' do
  ...
  context 'given a mismatched content type' do
    ...
    it 'is valid' do
      aggregate_failures do
        ...
        expect(person.errors.full_messages).to include('Avatar attatchment is larger than 600 KB limit')
      end
    end
  end
